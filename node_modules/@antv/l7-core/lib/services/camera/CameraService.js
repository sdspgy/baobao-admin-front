...
var CameraService = (_dec = (0, _inversify.injectable)(), _dec(_class = (_temp = function () {
  ...
  (0, _createClass2.default)(CameraService, [{
    ...
    value: function update(viewport) {
      ...
      this.viewMatrixInverse = _glMatrix.mat4.invert(_glMatrix.mat4.create(), this.getViewMatrix());
