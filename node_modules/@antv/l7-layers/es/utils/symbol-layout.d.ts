 ...
 */
export declare function shapeText(text: string, glyphs: any, lineHeight: number, textAnchor: string, textJustify: string, spacing: number, translate?: [number, number]): false | {
