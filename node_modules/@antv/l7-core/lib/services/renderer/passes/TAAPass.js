...
var TAAPass = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_types.TYPES.IShaderModuleService), _dec3 = (0, _inversify.inject)(_types.TYPES.ILogService), _dec(_class = (_class2 = (_temp = function (_BaseNormalPass) {
  ...
  function TAAPass() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(TAAPass)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  (0, _createClass2.default)(TAAPass, [{
    ...
    value: function init(layer, config) {
      (0, _get2.default)((0, _getPrototypeOf3.default)(TAAPass.prototype), "init", this).call(this, layer, config);
